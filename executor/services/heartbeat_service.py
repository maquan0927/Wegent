    ...
    def __init__(
        ...
        Args:
            ...
            heartbeat_url: Full URL for heartbeat endpoint. If not provided,
                          constructs from EXECUTOR_MANAGER_CALLBACK_URL.
        ...
        if heartbeat_url:
            ...
            # Extract base URL and append heartbeat path
            ...
            self._heartbeat_url = f"{base_url}/sandboxes/{self._sandbox_id}/heartbeat"
