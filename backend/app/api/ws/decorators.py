...
from app.core.socketio_metrics import (
    record_connection,
    record_message_with_duration,
)
...
def trace_websocket_event(
    ...
    def decorator(func: Callable) -> Callable:
        ...
        async def wrapper(self, event: str, sid: str, *args):
            ...
            # Record connection events for Prometheus
            ...
            try:
                ...
                # Record Prometheus metrics for non-connection events
